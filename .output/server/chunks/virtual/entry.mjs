...
const componentsC_1oA3Vs = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  ...
  M: parseQuery,
  N: parseURL,
  O: isSameRouteLocationParams,
  R: useCallbacks,
  S: extractComponentsGuards,
  T: guardToPromiseFn,
  U: isNavigationFailure,
  V: createRouterError,
  W: matchedRouteKey,
  X: useRoute,
  Y: routerViewLocationKey,
  Z: viewDepthKey,
  _: createHref,
  a: defineKeyedFunctionFactory,
  b: encodeParam,
  c: addAPIProvider,
  d: virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Fapp_config_default,
  f: _mergeTransitionProps,
  h: START_LOCATION_NORMALIZED,
  i: dataDiagnostics,
  j: normalizeQuery,
  k: isSameRouteRecord,
  l: setCustomIconsLoader,
  m: isChangingPage,
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	...
	},
	{
		name: "login",
		path: "/login",
		component: () => import('../build/login-BfbaSf6w.mjs')
	},
	{
	...
	},
	{
		...
		component: () => import('../build/pages-Dmb9txg9.mjs')
	}
];
//#endregion
