import { aK as useRoute, aP as useToast, aM as useRuntimeConfig, al as useAuth, j as _sfc_main$2$1 } from '../virtual/entry.mjs';
import { d as _sfc_main$7, c as _sfc_main$5, U as UserMenu_default, b as _sfc_main$4, a as _sfc_main$2, _ as _sfc_main, N as NotificationsSlideover_default } from './NotificationsSlideover-Bhu5S-sH.mjs';
...
import './virtualizer-BXaFupVX.mjs';
...
var general_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		const links = computed(() => {
			...
			if (hasPermission("inbox.view")) items.push({
			...
			if (hasPermission("points.redeem.payout")) items.push({
...
//# sourceMappingURL=general-Cw0pkIig.mjs.map
