import { ap as useComponentProps, aj as useAppConfig, ag as tv, q as createReusableTemplate, c as Primitive, j as _sfc_main$2$1 } from '../virtual/entry.mjs';
import { l as useDashboard, q as useResizable, d as _sfc_main$1$1, _ as _sfc_main$2 } from './DashboardSidebarToggle-J0oVNQdJ.mjs';
import { useId, toRef, computed, mergeProps, unref, useSlots, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, createVNode, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
//#endregion
//#region node_modules/.pnpm/@nuxt+ui@4.10.0_a6bdf891eb6b0c16e122bd866561a18f/node_modules/@nuxt/ui/dist/runtime/components/DashboardPanel.vue
...
_sfc_main$1.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.10.0_a6bdf891eb6b0c16e122bd866561a18f/node_modules/@nuxt/ui/dist/runtime/components/DashboardPanel.vue");
...
//#endregion
//#region node_modules/.pnpm/@nuxt+ui@4.10.0_a6bdf891eb6b0c16e122bd866561a18f/node_modules/@nuxt/ui/dist/runtime/components/DashboardNavbar.vue
			...
			_push(ssrRenderComponent(unref(DefineToggleTemplate), null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) ssrRenderSlot(_ctx.$slots, "toggle", {
						...
						if (unref(props).toggle) _push(ssrRenderComponent(_sfc_main$2, mergeProps(typeof unref(props).toggle === "object" ? unref(props).toggle : {}, {
						...
						...unref(dashboardContext),
						ui: ui.value
					}, () => [unref(props).toggle ? (openBlock(), createBlock(_sfc_main$2, mergeProps({ key: 0 }, typeof unref(props).toggle === "object" ? unref(props).toggle : {}, {
						side: unref(props).toggleSide,
						"data-slot": "toggle",
						class: ui.value.toggle({
							class: unref(props).ui?.toggle,
...
_sfc_main.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.10.0_a6bdf891eb6b0c16e122bd866561a18f/node_modules/@nuxt/ui/dist/runtime/components/DashboardNavbar.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _, _sfc_main$1 as a };
//# sourceMappingURL=DashboardNavbar-BzzI9nrt.mjs.map
