...
var distributor_portal_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "layout-shell" }, _attrs))} data-v-cee1d2e8><div class="layout-wrapper" data-v-cee1d2e8><div class="page-content" data-v-cee1d2e8>`);
			ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
			_push(`</div><nav class="bottom-nav" data-v-cee1d2e8><button type="button" class="${ssrRenderClass([{ active: isInicioActive.value }, "nav-item"])}" data-v-cee1d2e8><span class="nav-icon" data-v-cee1d2e8>🏠</span><span class="nav-label" data-v-cee1d2e8>Inicio</span></button><button type="button" class="${ssrRenderClass([{ active: isClientesActive.value }, "nav-item"])}" data-v-cee1d2e8><span class="nav-icon" data-v-cee1d2e8>👥</span><span class="nav-label" data-v-cee1d2e8>Clientes</span></button><button type="button" class="${ssrRenderClass([{ active: isEstadoCuentaActive.value }, "nav-item"])}" data-v-cee1d2e8><span class="nav-icon" data-v-cee1d2e8>📊</span><span class="nav-label" data-v-cee1d2e8>Estado Cuenta</span></button><button type="button" class="${ssrRenderClass([{ active: isPuntosActive.value }, "nav-item"])}" data-v-cee1d2e8><span class="nav-icon" data-v-cee1d2e8>⭐</span><span class="nav-label" data-v-cee1d2e8>Puntos</span></button></nav></div></div>`);
		};
	}
});
//#endregion
...
var distributor_portal_default = /*#__PURE__*/ _plugin_vue_export_helper_default(distributor_portal_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-cee1d2e8"]]);

export { distributor_portal_default as default };
//# sourceMappingURL=distributor-portal-DypUE9zy.mjs.map
