...
function useReconciliations() {
	...
	async function rejectReconciliation(id, rejectionReason) {
		await $fetch$2(`${config.public.apiBase}/reconciliations/${id}/reject`, {
			method: "POST",
			headers: { Authorization: `Bearer ${token.value}` },
...
//# sourceMappingURL=useReconciliations-D-H88Ltl.mjs.map
