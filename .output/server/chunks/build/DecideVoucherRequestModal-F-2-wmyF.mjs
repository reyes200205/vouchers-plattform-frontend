import { _ as _sfc_main$2 } from './FormField-CDI7tGjZ.mjs';
import { _ as _sfc_main$5 } from './RadioGroup-uhRnso-5.mjs';
import { aP as useToast, f as _sfc_main$1 } from '../virtual/entry.mjs';
import { _ as _sfc_main } from './Modal-BQ_M11w-.mjs';
import { u as useCustomers } from './useCustomers-Z8wRBFPR.mjs';
import { u as useVouchers } from './useVouchers-hob04OlF.mjs';
import { _ as _sfc_main$4 } from './Form-j1wdqi9R.mjs';
import { _ as _sfc_main$3 } from './Textarea-ChxtXYe7.mjs';
import { C as ChangeCustomerRequestModal_default } from './ChangeCustomerRequestModal-DNYa9J8P.mjs';
		...
		async function onSubmit(event) {
			...
			try {
				...
				toast.add({
					...
					description: decision.value === "APROBADO" ? "El vale fue aprobado. Cuando el cliente se presente con el correo que ya recibió, entrégale el vale desde \"Vales emitidos\"." : "La solicitud de vale fue rechazada.",
					color: "success"
				});
				open.value = false;
				emit("decided");
...
//# sourceMappingURL=DecideVoucherRequestModal-F-2-wmyF.mjs.map
