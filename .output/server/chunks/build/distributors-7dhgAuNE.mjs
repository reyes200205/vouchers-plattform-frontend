...
//#region app/pages/general/distributors.vue?vue&type=script&setup=true&lang.ts
var distributors_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	async setup(__props) {
		...
		const q = ref("");
		const page = ref(1);
		const { data, status, refresh } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("distributors", () => listDistributors({
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_UDashboardPanel, mergeProps({ id: "distributors" }, _attrs), {
				header: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(_component_UDashboardNavbar, { title: "Distribuidoras" }, {
					...
					else return [createVNode(_component_UDashboardNavbar, { title: "Distribuidoras" }, {
...
//#endregion
//#region app/pages/general/distributors.vue
...
distributors_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/general/distributors.vue");
...
//# sourceMappingURL=distributors-7dhgAuNE.mjs.map
