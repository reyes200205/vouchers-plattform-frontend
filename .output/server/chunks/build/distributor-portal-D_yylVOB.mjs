...
var CreditHeader_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "credit-header" }, _attrs))} data-v-3028df95><div class="top-bar" data-v-3028df95><span class="brand-name" data-v-3028df95>Mis<span data-v-3028df95>Vales</span></span><button class="logout-btn" type="button" aria-label="Cerrar sesión" data-v-3028df95>`);
			_push(ssrRenderComponent(unref(LogOut), { size: 15 }, null, _parent));
			_push(`</button></div><div class="credit-card" data-v-3028df95><div class="credit-title-row" data-v-3028df95><span class="credit-label" data-v-3028df95>Crédito disponible</span><span class="category-chip" data-v-3028df95>${ssrInterpolate(__props.categoryName)}</span></div><div class="credit-value" data-v-3028df95>${ssrInterpolate(__props.unlimitedCredit ? "Ilimitado" : money(__props.availableCredit))}</div><p class="check-line" data-v-3028df95>`);
			_push(ssrRenderComponent(unref(CircleCheck), { size: 14 }, null, _parent));
			_push(`<strong data-v-3028df95>${ssrInterpolate(__props.points.toLocaleString("es-MX"))}</strong> puntos acumulados </p>`);
			if (!__props.unlimitedCredit) _push(`<!--[--><div class="progress-track" data-v-3028df95><div class="progress-value" style="${ssrRenderStyle({ width: `${unref(percentage)}%` })}" data-v-3028df95></div></div><div class="amounts-row" data-v-3028df95><span data-v-3028df95>Usado ${ssrInterpolate(money(unref(usedCredit)))}</span><span data-v-3028df95>Límite ${ssrInterpolate(money(__props.creditLimit))}</span></div><!--]-->`);
			else _push(`<!---->`);
			_push(`</div></section>`);
		};
	}
...
var CreditHeader_default = /*#__PURE__*/ Object.assign(_plugin_vue_export_helper_default(CreditHeader_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-3028df95"]]), { __name: "DistributorCreditHeader" });
//#endregion
...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "home-container" }, _attrs))} data-v-5c58cdb9>`);
			...
			_push(`<div class="content-body" data-v-5c58cdb9>`);
			if (loading.value) _push(`<p class="state-text" data-v-5c58cdb9><span class="spinner" data-v-5c58cdb9></span> Cargando vales… </p>`);
			else if (errorMessage.value) _push(`<p class="state-text error" data-v-5c58cdb9>${ssrInterpolate(errorMessage.value)}</p>`);
			else if (rows.value.length === 0) _push(`<div class="empty-state" data-v-5c58cdb9><span class="empty-icon" data-v-5c58cdb9>📄</span><p data-v-5c58cdb9>Todavía no tienes vales emitidos.</p></div>`);
...
var distributor_portal_default = /*#__PURE__*/ _plugin_vue_export_helper_default(index_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-5c58cdb9"]]);

export { distributor_portal_default as default };
//# sourceMappingURL=distributor-portal-D_yylVOB.mjs.map
