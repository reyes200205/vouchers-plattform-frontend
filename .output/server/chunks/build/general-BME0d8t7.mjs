...
var general_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		const links = computed(() => {
			...
			if (hasPermission("inbox.view") && (!isRestrictedRole || config.public.channel === "vpn")) items.push({
			...
			if (hasPermission("distributors.view")) items.push({
...
//# sourceMappingURL=general-BME0d8t7.mjs.map
