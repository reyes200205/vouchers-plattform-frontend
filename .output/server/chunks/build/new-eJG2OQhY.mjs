...
import { defineComponent, computed, reactive, ref, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, isRef, createCommentVNode, withDirectives, vShow, useSSRContext } from 'vue';
...
var new_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		const schema = z.object({
			...
			home_phone: z.string().min(1, "El otro teléfono de contacto es obligatorio"),
...
//# sourceMappingURL=new-eJG2OQhY.mjs.map
