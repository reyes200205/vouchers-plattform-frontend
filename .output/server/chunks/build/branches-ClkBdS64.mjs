import { aK as useToast, ah as useAsyncData, h as _sfc_main$7 } from '../virtual/entry.mjs';
import { _ as _sfc_main$5 } from './Select-D1QrJt5i.mjs';
import { _ as _sfc_main$2 } from './DropdownMenu-diPbuNA_.mjs';
import { _ as _sfc_main$4 } from './Kbd-CHYMLSD7.mjs';
import { _ as _sfc_main$a } from './Modal-CQaPjRhv.mjs';
import { a as _sfc_main$1, _ as _sfc_main$8 } from './Pagination-DJdTeTHe.mjs';
import { _ as _sfc_main$c } from './FormField-DOShaxcI.mjs';
import { _ as _sfc_main$d } from './Tabs-C4ooqijJ.mjs';
import { _ as _sfc_main } from './Badge-BYCOpnRl.mjs';
import { _ as _sfc_main$3 } from './Input-04Z3Y5rE.mjs';
import { u as useAuth } from './useAuth-B7H4jTnU.mjs';
import { b as _sfc_main$2$1, a as _sfc_main$1$1, _ as _sfc_main$9 } from './DashboardSidebarCollapse-DBHlrYy7.mjs';
import { _ as _sfc_main$b } from './Form-DpngGyYw.mjs';
import { u as useBranches } from './useBranches-BbWoD2ZH.mjs';
import { _ as _sfc_main$6 } from './Table-BTtFuN8i.mjs';
...
import './namespaced-CnJbKBbD.mjs';
...
var SettingsModal_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		watch(open, async (isOpen) => {
			if (!isOpen) return;
			loading.value = true;
			state.default_credit_limit = void 0;
			state.opening_commission_percentage = void 0;
			state.biweekly_interest_percentage = void 0;
			state.late_payment_penalty_amount = void 0;
			...
			try {
				...
				state.default_credit_limit = branchSettings.default_credit_limit ?? void 0;
				state.opening_commission_percentage = branchSettings.opening_commission_percentage ?? void 0;
				state.biweekly_interest_percentage = branchSettings.biweekly_interest_percentage ?? void 0;
				state.late_payment_penalty_amount = branchSettings.late_payment_penalty_amount ?? void 0;
		...
		async function onSubmit(event) {
			...
			try {
				const branchPayload = {
					default_credit_limit: event.data.default_credit_limit ? String(event.data.default_credit_limit) : void 0,
					opening_commission_percentage: event.data.opening_commission_percentage ? String(event.data.opening_commission_percentage) : void 0,
					biweekly_interest_percentage: event.data.biweekly_interest_percentage ? String(event.data.biweekly_interest_percentage) : void 0,
					late_payment_penalty_amount: event.data.late_payment_penalty_amount ? String(event.data.late_payment_penalty_amount) : void 0,
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								...
								if (unref(tab) === "branch") {
									...
									_push(ssrRenderComponent(_component_UFormField, {
										label: "Límite de crédito por defecto (MXN)",
										name: "default_credit_limit"
									}, {
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(ssrRenderComponent(_component_UInput, {
												modelValue: unref(state).default_credit_limit,
												"onUpdate:modelValue": ($event) => unref(state).default_credit_limit = $event,
												type: "number",
												min: "0",
												step: "100",
												class: "w-full"
									...
									_push(ssrRenderComponent(_component_UFormField, {
										label: "Penalización por atraso (MXN)",
...
//# sourceMappingURL=branches-ClkBdS64.mjs.map
