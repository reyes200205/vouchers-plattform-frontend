...
import { _ as _sfc_main$2 } from './Select-QzRNfVS-.mjs';
import { _ as _sfc_main$3 } from './DropdownMenu-pA38i_hv.mjs';
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			ssrRenderList(__props.members, (member, index) => {
				_push(`<li class="flex items-center justify-between gap-3 px-6 py-3"><div class="flex items-center gap-3 min-w-0">`);
...
//# sourceMappingURL=members-BadrPMxY.mjs.map
