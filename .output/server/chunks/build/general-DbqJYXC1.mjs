import { ai as useAsyncData, g as _sfc_main$2$1, h as _sfc_main$7, j as _sfc_main$9, aj as useAuth, $ as $fetch$2, aJ as useRuntimeConfig, an as useComponentProps, ah as useAppConfig, ae as tv, b as Primitive } from '../virtual/entry.mjs';
import { _ as _sfc_main$3 } from './Select-QzRNfVS-.mjs';
import { _ as _sfc_main$4 } from './Tooltip-h5hgSInC.mjs';
import { u as useDashboard } from './useDashboard-D4HEKIwL.mjs';
import { b as _sfc_main$2, a as _sfc_main$1, _ as _sfc_main$5 } from './DashboardSidebarCollapse-CLHbm061.mjs';
import { u as useBranches } from './useBranches-CPhggLZ3.mjs';
import { _ as _sfc_main$a } from './Table-D5F1Zuzy.mjs';
			...
			_push(ssrRenderComponent(_component_UDashboardPanel, mergeProps({ id: "home" }, _attrs), {
				...
				body: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) if (unref(status) === "pending" && !unref(stats)) {
						...
						name: "i-lucide-loader-circle",
						class: "size-8 animate-spin text-muted"
					})])) : (openBlock(), createBlock(Fragment, { key: 1 }, [createVNode(_component_HomeStats, { stats: unref(stats) }, null, 8, ["stats"]), createVNode("div", { class: "grid grid-cols-2 gap-6 mt-4" }, [createVNode(_component_HomeChart, {
						title: "Colocación mensual",
						points: unref(stats)?.monthly_placement ?? []
...
//# sourceMappingURL=general-DbqJYXC1.mjs.map
