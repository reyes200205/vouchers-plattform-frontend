...
var distributor_portal_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "layout-shell" }, _attrs))} data-v-b6ef903c><div class="layout-wrapper" data-v-b6ef903c><div class="page-content" data-v-b6ef903c>`);
			ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
			_push(`</div><nav class="bottom-nav" data-v-b6ef903c><button type="button" class="${ssrRenderClass([{ active: isInicioActive.value }, "nav-item"])}" data-v-b6ef903c><span class="nav-icon-wrap" data-v-b6ef903c>`);
			_push(ssrRenderComponent(unref(House), { size: 20 }, null, _parent));
			_push(`</span><span class="nav-label" data-v-b6ef903c>Inicio</span></button><button type="button" class="${ssrRenderClass([{ active: isClientesActive.value }, "nav-item"])}" data-v-b6ef903c><span class="nav-icon-wrap" data-v-b6ef903c>`);
			_push(ssrRenderComponent(unref(Users), { size: 20 }, null, _parent));
			_push(`</span><span class="nav-label" data-v-b6ef903c>Clientes</span></button><button type="button" class="${ssrRenderClass([{ active: isEstadoCuentaActive.value }, "nav-item"])}" data-v-b6ef903c><span class="nav-icon-wrap" data-v-b6ef903c>`);
			_push(ssrRenderComponent(unref(FileText), { size: 20 }, null, _parent));
			_push(`</span><span class="nav-label" data-v-b6ef903c>Estado Cuenta</span></button><button type="button" class="${ssrRenderClass([{ active: isPuntosActive.value }, "nav-item"])}" data-v-b6ef903c><span class="nav-icon-wrap" data-v-b6ef903c>`);
			_push(ssrRenderComponent(unref(Coins), { size: 20 }, null, _parent));
			_push(`</span><span class="nav-label" data-v-b6ef903c>Puntos</span></button></nav></div></div>`);
		};
	}
});
//#endregion
...
var distributor_portal_default = /*#__PURE__*/ _plugin_vue_export_helper_default(distributor_portal_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-b6ef903c"]]);

export { distributor_portal_default as default };
//# sourceMappingURL=distributor-portal-HPWzVVM0.mjs.map
