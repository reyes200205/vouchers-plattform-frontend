import { an as useComponentProps, ah as useAppConfig, aw as useForwardProps, a6 as reactivePick, o as createReusableTemplate, ae as tv, U as isArrayOfArray, i as _sfc_main$8, j as _sfc_main$9, g as _sfc_main$2, H as get, e as _sfc_main$4, a3 as pickLinkProps, f as _sfc_main$1$1, av as useForwardExpose, ak as useCollection, b as Primitive, a7 as refAutoReset, V as VisuallyHidden_default, aD as usePortal, F as FieldGroupReset, a5 as reactiveOmit, P as Presence_default, aN as useVModel, ap as useDebounceFn, as as useEventListener, aG as useResizeObserver, k as createContext, I as getActiveElement, af as unrefElement } from '../virtual/entry.mjs';
import { r as useId$1, p as useForwardPropsEmits, o as useDirection, D as DismissableLayer_default } from './PopperArrow-Cwqi64q5.mjs';
import { i as isValueEqualOrExist } from './isValueEqualOrExist-B3YcscFO.mjs';
import { H as HoverCard, P as Popover, u as useArrowNavigation } from './namespaced-DaSSdVt2.mjs';
import { _ as _sfc_main$5 } from './Tooltip-h5hgSInC.mjs';
import { p as pointerDownOutside } from './overlay-BtFRc-iG.mjs';
import { _ as _sfc_main$3 } from './Badge-B12zNpDE.mjs';
import { useSlots, computed, toRef, unref, withCtx, mergeProps, createVNode, resolveDynamicComponent, renderSlot, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString, Fragment, renderList, defineComponent, withKeys, ref, createElementBlock, toHandlers, Teleport, toRefs, watchEffect, watch, nextTick, useSSRContext } from 'vue';
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								if (unref(props).orientation === "vertical" && item.type === "label" && !unref(props).collapsed) {
									...
									_push(`</div>`);
								} else if (item.type !== "label") _push(ssrRenderComponent(_sfc_main$4, mergeProps(unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
									default: withCtx(({ active, ...slotProps }, _push, _parent, _scopeId) => {
										if (_push) {
											ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) ? unref(NavigationMenuTrigger_default) : unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && !slotProps.href ? unref(AccordionTrigger_default) : unref(NavigationMenuLink_default)), {
												...
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) if (unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover)) _push(ssrRenderComponent(_sfc_main$1, mergeProps({
														...popoverProps.value,
														...
														content: withCtx(({ close }, _push, _parent, _scopeId) => {
															if (_push) ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
																...
																ssrRenderList(item.children, (childItem, childIndex) => {
																	...
																	_push(ssrRenderComponent(_sfc_main$4, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
																...
																}, [createVNode(_sfc_main$4, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
													...
													else return [unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$1, mergeProps({ key: 0 }, {
														...popoverProps.value,
														...typeof item.popover === "boolean" ? {} : item.popover || {}
													}, { ui: { content: ui.value.content({ class: [unref(props).ui?.content, item.ui?.content] }) } }), {
											...
											default: withCtx(() => [unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$1, mergeProps({ key: 0 }, {
												...popoverProps.value,
												...typeof item.popover === "boolean" ? {} : item.popover || {}
											}, { ui: { content: ui.value.content({ class: [unref(props).ui?.content, item.ui?.content] }) } }), {
												content: withCtx(({ close }) => [renderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
								...
								item,
								index
							}, null, 8, ["item", "index"])], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$4, mergeProps({ key: 1 }, unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
...
//# sourceMappingURL=NavigationMenu-D1sIOeTf.mjs.map
