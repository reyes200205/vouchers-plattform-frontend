import { al as useAuth, aP as useToast, aL as useRouter, j as _sfc_main$2$1, f as _sfc_main$9, ap as useComponentProps, aQ as useVModel, aB as useLocale$1, aj as useAppConfig, ay as useForwardProps, a8 as reactivePick, aw as useFormField, av as useFieldGroup, ag as tv, aH as usePrimitiveElement, Z as isNullish, c as Primitive, U as injectConfigProviderContext, a6 as reactiveComputed, m as createContext, L as getActiveElement, ah as unrefElement, n as createEventHook } from '../virtual/entry.mjs';
import { _ as _sfc_main$8, s as snapValueToStep, c as clamp } from './Select-Gak9P_dI.mjs';
...
import { _ as _sfc_main$6 } from './FormField-CDI7tGjZ.mjs';
import { _ as _sfc_main$5 } from './Badge-CfJUAgXt.mjs';
...
import { a as _sfc_main$1, _ as _sfc_main$a } from './DashboardNavbar-C9AMA1qv.mjs';
import { _ as _sfc_main$b } from './DashboardSidebarCollapse-D6jKUkvL.mjs';
import { _ as _sfc_main$3 } from './Form-j1wdqi9R.mjs';
import { u as useApplications } from './useApplications-BexvP3mx.mjs';
import { _ as _sfc_main$4 } from './Card-DDEFuVEm.mjs';
import { _ as _sfc_main$2 } from './Alert-C59La3DT.mjs';
import { E as EvidencePhotoCapture_default } from './EvidencePhotoCapture-qvUItMgX.mjs';
import { defineComponent, computed, reactive, ref, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, isRef, useTemplateRef, toRef, renderSlot, createCommentVNode, toRefs, watch, withModifiers, useSSRContext } from 'vue';
...
//#endregion
//#region node_modules/.pnpm/@nuxt+ui@4.10.0_a6bdf891eb6b0c16e122bd866561a18f/node_modules/@nuxt/ui/dist/runtime/components/InputNumber.vue
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (!!unref(props).increment) {
							...
							_push(ssrRenderComponent(unref(NumberFieldIncrement_default), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									...
									else return [renderSlot(_ctx.$slots, "increment", {}, () => [createVNode(_sfc_main$9, mergeProps({
										icon: incrementIcon.value,
										color: unref(color),
										size: inputSize.value,
										variant: "link",
						...
						if (!!unref(props).decrement) {
							...
							_push(ssrRenderComponent(unref(NumberFieldDecrement_default), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									...
									else return [renderSlot(_ctx.$slots, "decrement", {}, () => [createVNode(_sfc_main$9, mergeProps({
										icon: decrementIcon.value,
										color: unref(color),
										size: inputSize.value,
										variant: "link",
						...
						!!unref(props).increment ? (openBlock(), createBlock("div", {
							...
							default: withCtx(() => [renderSlot(_ctx.$slots, "increment", {}, () => [createVNode(_sfc_main$9, mergeProps({
								icon: incrementIcon.value,
								color: unref(color),
								size: inputSize.value,
								variant: "link",
						...
						!!unref(props).decrement ? (openBlock(), createBlock("div", {
							...
							default: withCtx(() => [renderSlot(_ctx.$slots, "decrement", {}, () => [createVNode(_sfc_main$9, mergeProps({
								icon: decrementIcon.value,
								color: unref(color),
								size: inputSize.value,
								variant: "link",
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.10.0_a6bdf891eb6b0c16e122bd866561a18f/node_modules/@nuxt/ui/dist/runtime/components/InputNumber.vue");
							...
							if (_push) {
								...
								_push(ssrRenderComponent(_component_UCard, null, {
									...
									default: withCtx((_, _push, _parent, _scopeId) => {
										if (_push) {
											_push(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}>`);
											_push(ssrRenderComponent(_component_UFormField, { label: "INE (frontal)" }, {
												default: withCtx((_, _push, _parent, _scopeId) => {
											...
											_push(ssrRenderComponent(_component_UFormField, { label: "INE (reverso)" }, {
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) _push(ssrRenderComponent(_component_ApplicationsEvidencePhotoCapture, {
											...
											_push(ssrRenderComponent(_component_UFormField, { label: "Comprobante de domicilio" }, {
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) _push(ssrRenderComponent(_component_ApplicationsEvidencePhotoCapture, {
											...
											createVNode(_component_UFormField, { label: "INE (frontal)" }, {
											...
											createVNode(_component_UFormField, { label: "INE (reverso)" }, {
												default: withCtx(() => [createVNode(_component_ApplicationsEvidencePhotoCapture, {
													modelValue: unref(idBackPath),
													"onUpdate:modelValue": ($event) => isRef(idBackPath) ? idBackPath.value = $event : null,
													upload: (file) => unref(uploadApplicationDocument)(file, "id_back"),
											...
											createVNode(_component_UFormField, { label: "Comprobante de domicilio" }, {
												default: withCtx(() => [createVNode(_component_ApplicationsEvidencePhotoCapture, {
													modelValue: unref(proofOfAddressPath),
													"onUpdate:modelValue": ($event) => isRef(proofOfAddressPath) ? proofOfAddressPath.value = $event : null,
													upload: (file) => unref(uploadApplicationDocument)(file, "proof_of_address"),
...
//# sourceMappingURL=new-DDCCzRQ2.mjs.map
