import { ap as useComponentProps, aQ as useVModel, aB as useLocale$1, aj as useAppConfig, ay as useForwardProps, a8 as reactivePick, aw as useFormField, av as useFieldGroup, ag as tv, f as _sfc_main$1, aH as usePrimitiveElement, Z as isNullish, c as Primitive, U as injectConfigProviderContext, a6 as reactiveComputed, m as createContext, L as getActiveElement, ah as unrefElement, n as createEventHook } from '../virtual/entry.mjs';
import { s as snapValueToStep, c as clamp } from './Select-5EkiFePr.mjs';
...
import { computed, useTemplateRef, toRef, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createCommentVNode, defineComponent, toRefs, ref, watch, withModifiers, useSSRContext } from 'vue';
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (!!unref(props).increment) {
							...
							_push(ssrRenderComponent(unref(NumberFieldIncrement_default), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									...
									else return [renderSlot(_ctx.$slots, "increment", {}, () => [createVNode(_sfc_main$1, mergeProps({
										icon: incrementIcon.value,
										color: unref(color),
										size: inputSize.value,
										variant: "link",
						...
						if (!!unref(props).decrement) {
							...
							_push(ssrRenderComponent(unref(NumberFieldDecrement_default), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									...
									else return [renderSlot(_ctx.$slots, "decrement", {}, () => [createVNode(_sfc_main$1, mergeProps({
										icon: decrementIcon.value,
										color: unref(color),
										size: inputSize.value,
										variant: "link",
						...
						!!unref(props).increment ? (openBlock(), createBlock("div", {
							...
							default: withCtx(() => [renderSlot(_ctx.$slots, "increment", {}, () => [createVNode(_sfc_main$1, mergeProps({
								icon: incrementIcon.value,
								color: unref(color),
								size: inputSize.value,
								variant: "link",
						...
						!!unref(props).decrement ? (openBlock(), createBlock("div", {
							...
							default: withCtx(() => [renderSlot(_ctx.$slots, "decrement", {}, () => [createVNode(_sfc_main$1, mergeProps({
								icon: decrementIcon.value,
								color: unref(color),
								size: inputSize.value,
								variant: "link",
...
//# sourceMappingURL=InputNumber-VA_FGM2O.mjs.map
