import { ao as useComponentProps, aO as useVModel, az as useLocale, ai as useAppConfig, ax as useForwardProps, a7 as reactivePick, av as useFormField, au as useFieldGroup, af as tv, h as _sfc_main$7, aF as usePrimitiveElement, X as isNullish, b as Primitive, a5 as reactiveComputed, l as createContext, K as getActiveElement, ag as unrefElement, m as createEventHook } from '../virtual/entry.mjs';
import { s as snapValueToStep, c as clamp } from './Select-COOtR1SR.mjs';
import { o as useLocale$1, k as useComposing, n as useKbd } from './utils-D4TVPsMb.mjs';
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (!!unref(props).increment) {
							...
							_push(ssrRenderComponent(unref(NumberFieldIncrement_default), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									...
									else return [renderSlot(_ctx.$slots, "increment", {}, () => [createVNode(_sfc_main$7, mergeProps({
										icon: incrementIcon.value,
										color: unref(color),
										size: inputSize.value,
										variant: "link",
						...
						if (!!unref(props).decrement) {
							...
							_push(ssrRenderComponent(unref(NumberFieldDecrement_default), {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									...
									else return [renderSlot(_ctx.$slots, "decrement", {}, () => [createVNode(_sfc_main$7, mergeProps({
										icon: decrementIcon.value,
										color: unref(color),
										size: inputSize.value,
										variant: "link",
						...
						!!unref(props).increment ? (openBlock(), createBlock("div", {
							...
							default: withCtx(() => [renderSlot(_ctx.$slots, "increment", {}, () => [createVNode(_sfc_main$7, mergeProps({
								icon: incrementIcon.value,
								color: unref(color),
								size: inputSize.value,
								variant: "link",
						...
						!!unref(props).decrement ? (openBlock(), createBlock("div", {
							...
							default: withCtx(() => [renderSlot(_ctx.$slots, "decrement", {}, () => [createVNode(_sfc_main$7, mergeProps({
								icon: decrementIcon.value,
								color: unref(color),
								size: inputSize.value,
								variant: "link",
...
//# sourceMappingURL=InputNumber-BvTEwE0l.mjs.map
