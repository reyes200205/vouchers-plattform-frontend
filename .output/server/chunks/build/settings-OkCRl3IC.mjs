import { _ as _sfc_main$4 } from './NavigationMenu-pBOt4Q71.mjs';
import { a2 as page_default } from '../virtual/entry.mjs';
import { b as _sfc_main$2, a as _sfc_main$1, _ as _sfc_main } from './DashboardSidebarCollapse-sUUZuiM3.mjs';
import { _ as _sfc_main$3 } from './DashboardToolbar-zoEec-zs.mjs';
...
import './Tooltip-BI5myhCR.mjs';
import './Badge-ClJo_FRE.mjs';
import './Popover-CseV9sF-.mjs';
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_UDashboardPanel, mergeProps({
				...
				body: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="flex flex-col gap-4 sm:gap-6 lg:gap-12 w-full lg:max-w-2xl mx-auto"${_scopeId}>`);
						_push(ssrRenderComponent(_component_NuxtPage, null, null, _parent, _scopeId));
						_push(`</div>`);
					} else return [createVNode("div", { class: "flex flex-col gap-4 sm:gap-6 lg:gap-12 w-full lg:max-w-2xl mx-auto" }, [createVNode(_component_NuxtPage)])];
				}),
				_: 1
			}, _parent));
		};
...
//# sourceMappingURL=settings-OkCRl3IC.mjs.map
