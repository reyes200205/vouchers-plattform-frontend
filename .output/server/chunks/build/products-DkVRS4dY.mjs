...
import { _ as _sfc_main$d } from './Switch-BVVTXEME.mjs';
import { _ as _sfc_main$a } from './Modal-C3ktQuxc.mjs';
import { _ as _sfc_main$3 } from './Badge-BBG1L7MO.mjs';
import { _ as _sfc_main$8 } from './Input-BC1I0LeZ.mjs';
...
import { _ as _sfc_main$9 } from './DashboardSidebarCollapse-Dp2MXVqm.mjs';
...
import { defineComponent, computed, withAsyncContext, ref, watch, withCtx, unref, createVNode, isRef, openBlock, createBlock, createCommentVNode, Fragment, renderList, toDisplayString, useModel, reactive, mergeProps, createTextVNode, mergeModels, useSSRContext } from 'vue';
				...
				header: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(_component_UDashboardNavbar, { title: "Productos y Vales" }, {
						...
						right: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								if (unref(showBranchSelector)) _push(ssrRenderComponent(_component_USelect, {
								...
								unref(showBranchSelector) ? (openBlock(), createBlock(_component_USelect, {
									key: 0,
									modelValue: unref(selectedBranchId),
									"onUpdate:modelValue": ($event) => isRef(selectedBranchId) ? selectedBranchId.value = $event : null,
									items: unref(branches).map((b) => ({
					...
					if (_push) if (unref(status) === "pending") {
						...
						if (unref(filteredItems).length === 0) {
							...
							ssrRenderList(unref(filteredItems), (product) => {
								...
								if (!unref(isSuperAdmin) && (unref(canManage) || product.origin === "global")) _push(ssrRenderComponent(_component_UDropdownMenu, { items: getProductItems(product) }, {
									default: withCtx((_, _push, _parent, _scopeId) => {
						...
						return openBlock(), createBlock("div", {
							...
							!unref(isSuperAdmin) && (unref(canManage) || product.origin === "global") ? (openBlock(), createBlock(_component_UDropdownMenu, {
								key: 3,
...
//# sourceMappingURL=products-DkVRS4dY.mjs.map
